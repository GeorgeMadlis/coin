# Authors — Complexity of Civilizations
...
- **Works to investigate**:
  - *The Logic of Collective Action: Public Goods and the Theory of Groups* (1965, Harvard University Press) — foundational statement of the free-rider problem and selective incentive theory
  - *The Rise and Decline of Nations: Economic Growth, Stagflation, and Social Rigidities* (1982, Yale University Press) — "institutional sclerosis" thesis; the work directly cited in the source
  - *Power and Prosperity: Outgrowing Communist and Capitalist Dictatorships* (2000, Basic Books) — posthumous; explores how political systems affect economic outcomes
- **URLs**:
  - [*The Logic of Collective Action* — Harvard University Press](https://www.hup.harvard.edu/books/9780674537514) — paywalled (book)
  - [*The Rise and Decline of Nations* — Amazon](https://www.amazon.com/Rise-Decline-Nations-Stagflation-Rigidities/dp/0300030797) — paywalled (book)
  - [Olson biography — Econlib](https://www.econlib.org/library/enc/bios/olson.html) — open
...
- **Works to investigate**:
  - *Dynamics of Complex Systems* (1997, Addison-Wesley) — first textbook unifying complex systems science; covers neural networks, protein folding, and human civilization
  - *Making Things Work* (2004, NECSI Knowledge Press) — applies complex systems science to healthcare, education, ethnic conflict
  - "Global Pattern Formation and Ethnic/Cultural Violence" (M. Lim, R. Metzler, Y. Bar-Yam; *Science* 317(5844), 2007) — the ethnic violence model cited in the source
  - "The Food Crises and Political Instability in North Africa and the Middle East" (M. Lagi, K. Z. Bertrand, Y. Bar-Yam; arXiv:1108.2455, 2011) — the food price / unrest prediction model
- **URLs**:
  - [*Dynamics of Complex Systems* — NECSI (free)](https://necsi.edu/dynamics-of-complex-systems) — open
  - ["Global Pattern Formation and Ethnic/Cultural Violence" — *Science*](https://www.science.org/doi/10.1126/science.1142734) — paywalled
  - ["The Food Crises and Political Instability…" — arXiv:1108.2455](https://arxiv.org/abs/1108.2455) — open
...
- **Works to investigate**:
  - "Political instability may be a contributor in the coming decade" (*Nature* 463(7281):608, February 2010; doi:10.1038/463608a) — the 2020-instability prediction letter directly cited in the source
  - *Ages of Discord: A Structural-Demographic Analysis of American History* (2016, Beresta Books) — quantitative model of US instability cycles cited in the source
  - *Secular Cycles* (with Sergey A. Nefedov; 2009, Princeton University Press) — mathematical treatment of recurring boom-bust cycles across pre-industrial states
  - *End Times: Elites, Counter-Elites and the Path of Political Disintegration* (2023, Allen Lane/Penguin) — most recent synthesis; updates predictions post-2020
- **URLs**:
  - ["Political instability may be a contributor in the coming decade" — *Nature*](https://www.nature.com/articles/463608a) — paywalled
  - [*Ages of Discord* — Amazon](https://www.amazon.com/Ages-Discord-Peter-Turchin/dp/0996139540) — paywalled (book)
  - [Turchin's publications page](https://peterturchin.com/cliodynamics-history-as-science/) — open
...
- **Works to investigate**:
  - "Entropy Collapse: A Universal Failure Mode of Intelligent Systems — Exact Phase Transition Analysis, First-Order Discontinuity, and Two Universality Classes" (Truong Xuan Khanh and Truong Quynh Hoa; arXiv:2512.12381, December 2025) — *Note: "Ken Hou and Houa" in the transcript appears to be a phonetic rendering of the Vietnamese names Khanh and Hoa. This paper derives exactly the threshold α_c = 1/(1−β) and proves first-order phase transition — a precise match for the claims attributed in the source.*
- **URLs**:
  - ["Entropy Collapse: A Universal Failure Mode of Intelligent Systems" — arXiv:2512.12381](https://arxiv.org/abs/2512.12381) — open
...
- **Works to investigate**:
  - "The vulnerability of aging states: A survival analysis across premodern societies" (Marten Scheffer, Egbert H. van Nes, Luke Kemp, Timothy A. Kohler, Timothy M. Lenton, Chi Xu; *PNAS* 120(49), 2023; doi:10.1073/pnas.2218834120) — the study directly cited in the source; survival analysis of 324 states over 4,000 years
- **URLs**:
  - ["The vulnerability of aging states…" — PNAS](https://www.pnas.org/doi/10.1073/pnas.2218834120) — open
...
- **Works to investigate**:
  - *The Constitution of Knowledge: A Defense of Truth* (2021, Brookings Institution Press) — his most prominent recent work on epistemology and democratic discourse; relevant to institutional resilience
- **URLs**:
  - [*The Constitution of Knowledge* — Brookings](https://www.brookings.edu/books/the-constitution-of-knowledge/) — open (publisher page)
  - [Jonathan Rauch profile — Brookings](https://www.brookings.edu/people/jonathan-rauch/) — open
